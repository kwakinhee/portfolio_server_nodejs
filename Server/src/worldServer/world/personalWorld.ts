...
export class PersonalWorld extends World {
  private networkedEntities = {};

  constructor(worldId: number) {
    super(worldId, EWorldType.PERSONAL_WORLD);
  }
  ...
  protected async _onJoin(user: User) {
    console.log(
      "************** User JOINED Personal WORLD LOGIC *****************"
    );
  ...
  protected async _onLeave(user: User) {
    console.log(
      "************** User LEFT Personal WORLD LOGIC *****************"
    );
  ...
  protected _onDestroy() {
    console.log(
      "************** WorldDestroyed Personal WORLD LOGIC *****************"
    );
